...
void c_step(Drive* env){
    ...
    if(env->timestep == env->scenario_length){
        add_log(env);
        // TODO look deeper into the termination strategies
...
Client* make_client(Drive* env){
    ...
    client->cars[0] = LoadModel("pufferdrive/assets/RedCar.glb");
    client->cars[1] = LoadModel("pufferdrive/assets/WhiteCar.glb");
    client->cars[2] = LoadModel("pufferdrive/assets/BlueCar.glb");
    client->cars[3] = LoadModel("pufferdrive/assets/YellowCar.glb");
    client->cars[4] = LoadModel("pufferdrive/assets/GreenCar.glb");
    client->cars[5] = LoadModel("pufferdrive/assets/GreyCar.glb");
    for (int i = 0; i < MAX_AGENTS; i++) {
